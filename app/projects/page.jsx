...
/*  const metadata = {
  ...
  keywords:
    "industrial waterproofing projects India, power plant waterproofing portfolio, tunnel repair case studies",
  ...
  openGraph: {
    ...
    images: [
      { url: "/logo.avif", width: 1200, height: 630, alt: "ZasChem India" },
    ],
  },
  twitter: {
      ...
      <section className="relative py-24 overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-6">
          ...
          <p className="text-brand-muted text-lg max-w-2xl">
            100+ completed projects across India's critical infrastructure —
            power plants, tunnels, dams, chemical plants, and industrial
            facilities. Real problems. Engineered solutions. Lasting results.
          </p>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-6 py-6 grid grid-cols-2 md:grid-cols-4 divide-x divide-brand-border">
          {[
            ...
            <div key={label} className="px-6 text-center">
              <p className="font-display font-black text-3xl text-on-bg">
                {val}
              </p>
      ...
      <section className="py-8">
        <div className="max-w-7xl mx-auto px-6 flex flex-wrap gap-3">
          {categories.map((cat) => (
            <span
              key={cat}
              className={`px-4 py-2 text-sm font-mono tracking-wider transition-all cursor-pointer
