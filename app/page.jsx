...
export const metadata = {
  ...
  keywords: 'industrial waterproofing India, waterproofing contractors, power plant waterproofing, tunnel rehabilitation, acid resistant lining, structural strengthening, ZasChem India',
  ...
  openGraph: {
    ...
    images: [{ url: '/og-home.avif', width: 1200, height: 630, alt: 'ZasChem India' }],
  },
  twitter: {
