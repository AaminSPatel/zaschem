        ...
        <div className="relative z-10 w-full max-w-7xl mx-auto px-6 pb-16">
          ...
          <h1 className="font-display font-black text-5xl md:text-7xl text-on-bg tracking-tight leading-none mb-4">
            {service.title.split(' ').map((w, i) => (
              <span key={i} className={i % 4 === 1 ? 'text-brand-blue' : 'text-on-bg'}>{w} </span>
            ))}
          </h1>
        ...
        <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 lg:grid-cols-3 gap-12">
          ...
          <div className="lg:col-span-2 space-y-10">
            ...
            <div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                {service.features.map((f) => (
                  <div key={f} className="flex items-center gap-3 p-4 bg-brand-card border border-brand-border">
            ...
            <div>
              ...
              <div className="grid grid-cols-2 sm:grid-cols-3 gap-3">
                {service.applications.map((a) => (
                  <div key={a} className="p-4 bg-brand-card border border-brand-border border-l-2 border-l-brand-orange">
            ...
            <div className="p-8 bg-brand-card border border-brand-border border-t-2 border-t-brand-blue">
              <h3 className="font-display font-bold text-xl text-on-bg mb-4">
                Why Choose ZAS Chem India for {service.title}?
              </h3>
              <div className="space-y-3 text-brand-muted text-sm leading-relaxed">
                <p>ZAS Chem India brings 12+ years of specialized experience in {service.title.toLowerCase()} to every project. Our engineering team conducts thorough site assessments before recommending the optimal solution, ensuring compatibility with existing structures and long-term performance.</p>
                <p>We deploy only certified applicators trained on international standards, use materials from globally accredited manufacturers, and maintain rigorous quality control documentation throughout project execution. Every {service.title.toLowerCase()} project is backed by a comprehensive warranty.</p>
              </div>
            </div>
          </div>
          ...
          <div className="space-y-6">
            ...
            <div className="card-industrial bg-brand-dark  p-6 border-t-2 border-t-brand-blue md:sticky top-24">
              ...
              <p className="text-brand-muted text-sm mb-6">Talk to our engineering team. Free technical consultation and site survey.</p>
              ...
              <a href="tel:+91-91-7004298988" className="btn-secondary w-full flex items-center justify-center gap-2">
