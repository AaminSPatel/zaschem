...
export const heroSlides = [
  {
    ...
    title: "POWER PLANT WATERPROOFING (ASTM C-836)",
    subtitle: "Industrial-Grade Waterproofing Systems as per ASTM C-836 & C-898 Standards",
    description: "Specialized PU waterproofing & heat reflecting coatings for cooling towers, terrace failure rectification, cable trench leakages, and transformer bunds. Zero site downtime.",
  ...
  },
  {
    ...
    title: "DAM & TUNNEL REHABILITATION",
    subtitle: "Soil Stabilization & Structural Leakage Restoration for Underground Infrastructure",
    description: "Advanced tunnel lining repair, low viscous epoxy injection, and high-pressure grout treatments for metro, spillway, inspection galleries, and highway tunnels.",
  ...
  },
  {
    ...
    title: "ACID ALKALI RESISTANT FURAN LINING",
    subtitle: "Chemical Plant Corrosion Protection as per IS Code 4860 & 4457",
    description: "Furan resin-based acid alkali resistant lining systems and tile lining for pits, tanks, trenches, chimney protective coatings, and industrial ETP plants.",
  ...
  },
  {
    ...
    title: "VACUUM DEWATERED TRIMIX FLOORING",
    subtitle: "Heavy-Duty Anti-Static, Mastic, Epoxy & PU Flooring Contractors",
    description: "High-performance Trimix flooring and chemical resistant floor systems designed with executive execution audits for harsh factory and warehouse environments.",
  ...
  },
  {
    ...
    title: "STRUCTURAL STRENGTHENING & REPAIR",
    subtitle: "Carbon Fiber & Glass Fiber Strengthening to Restore Ageing Concrete Structures",
    description: "Complete concrete repair, structural strengthening using carbon/glass wrapping, core cutting, rebar fixing, and polymer-modified restoration to fix spalling of concrete.",
...
export const testimonials = [
  {
    ...
    review: "ZasChem India's waterproofing solution for our cooling towers exceeded all expectations. The technical team demonstrated exceptional knowledge of power plant environments and delivered a lasting solution within our tight shutdown schedule.",
    rating: 5,
  ...
  },
  {
    ...
    review: "Working with ZasChem on our metro tunnel waterproofing was a seamless experience. Their team understood the criticality of the work, mobilized rapidly, and completed the repair within our 60-hour maintenance window. Highly recommended.",
    rating: 5,
  ...
  },
  {
    ...
    review: "The acid resistant lining installed by ZasChem in our ETP tanks has been performing without any issues for over 2 years now. Their understanding of chemical environments and appropriate material selection saved us significant costs.",
    rating: 5,
  ...
  },
  {
    ...
    review: "ZasChem's concrete repair methodology is thorough and systematic. They don't just patch problems — they diagnose the root cause and provide comprehensive solutions. Our plant structures have never been in better condition.",
    rating: 5,
  ...
  },
  {
    ...
    company: "Sun Pharma",
    review: "Our pharmaceutical facility's flooring upgrade by ZasChem helped us sail through FDA audit. The PU screed system is exactly what GMP compliance demands — seamless, hygienic, and chemically resistant.",
    rating: 5,
